...
class LemurVisitor : public antlr4::tree::AbstractParseTreeVisitor {
 public:
  ...
  virtual antlrcpp::Any visitGlobalstmt(
      LemurParser::GlobalstmtContext *context) = 0;

  virtual antlrcpp::Any visitClassdef(
      LemurParser::ClassdefContext *context) = 0;

  virtual antlrcpp::Any visitClassbody(
      LemurParser::ClassbodyContext *context) = 0;

  virtual antlrcpp::Any visitClassvardecl(
      LemurParser::ClassvardeclContext *context) = 0;

  virtual antlrcpp::Any visitClassfunctiondef(
      LemurParser::ClassfunctiondefContext *context) = 0;

  virtual antlrcpp::Any visitFunctiondef(
      LemurParser::FunctiondefContext *context) = 0;

  virtual antlrcpp::Any visitParamlist(
      LemurParser::ParamlistContext *context) = 0;
  ...
  virtual antlrcpp::Any visitPrintstmt(
      LemurParser::PrintstmtContext *context) = 0;
  ...
  virtual antlrcpp::Any visitIfElseExpr(
      LemurParser::IfElseExprContext *context) = 0;

  virtual antlrcpp::Any visitStringRule(
      LemurParser::StringRuleContext *context) = 0;

  virtual antlrcpp::Any visitOpExprRule(
      LemurParser::OpExprRuleContext *context) = 0;

  virtual antlrcpp::Any visitIndexRule(
      LemurParser::IndexRuleContext *context) = 0;

  virtual antlrcpp::Any visitMethodRule(
      LemurParser::MethodRuleContext *context) = 0;

  virtual antlrcpp::Any visitListRule(
      LemurParser::ListRuleContext *context) = 0;

  virtual antlrcpp::Any visitNumberRule(
      LemurParser::NumberRuleContext *context) = 0;

  virtual antlrcpp::Any visitUminusRule(
      LemurParser::UminusRuleContext *context) = 0;

  virtual antlrcpp::Any visitCallExprRule(
      LemurParser::CallExprRuleContext *context) = 0;
  ...
  virtual antlrcpp::Any visitCallexpr(
      LemurParser::CallexprContext *context) = 0;
  ...
  virtual antlrcpp::Any visitBinoperator(
      LemurParser::BinoperatorContext *context) = 0;

  virtual antlrcpp::Any visitBracedexpr(
      LemurParser::BracedexprContext *context) = 0;
};
